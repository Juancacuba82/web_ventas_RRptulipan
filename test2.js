...
fetch(url, {
    ...
    body: JSON.stringify({ operation_mode: 'sale', condition: 'used', zip_destino: '33606', container_size: '20std', options: { export_certificate: false, extra_service: false, crane_service: false } })
